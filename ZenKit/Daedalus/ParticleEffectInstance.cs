...
namespace ZenKit.Daedalus
{
	public class ParticleEffectInstance : DaedalusInstance
	{
		...
		public string PpsScaleKeysS =>
			Native.ZkParticleEffectInstance_getPpsScaleKeysS(Handle).MarshalAsString() ?? string.Empty;
		...
		public string PpsCreateEmS =>
			Native.ZkParticleEffectInstance_getPpsCreateEmS(Handle).MarshalAsString() ?? string.Empty;
		...
		public string ShpOffsetVecS =>
			Native.ZkParticleEffectInstance_getShpOffsetVecS(Handle).MarshalAsString() ?? string.Empty;
		...
		public string ShpScaleKeysS =>
			Native.ZkParticleEffectInstance_getShpScaleKeysS(Handle).MarshalAsString() ?? string.Empty;
		...
		public string FlyGravityS =>
			Native.ZkParticleEffectInstance_getFlyGravityS(Handle).MarshalAsString() ?? string.Empty;
		...
		public string VisSizeStartS =>
			Native.ZkParticleEffectInstance_getVisSizeStartS(Handle).MarshalAsString() ?? string.Empty;

		public float VisSizeEndScale => Native.ZkParticleEffectInstance_getVisSizeEndScale(Handle);

		public string VisAlphaFuncS =>
			Native.ZkParticleEffectInstance_getVisAlphaFuncS(Handle).MarshalAsString() ?? string.Empty;
		...
		public string TrlTextureS =>
			Native.ZkParticleEffectInstance_getTrlTextureS(Handle).MarshalAsString() ?? string.Empty;
		...
		public string MrkTextureS =>
			Native.ZkParticleEffectInstance_getMrktExtureS(Handle).MarshalAsString() ?? string.Empty;

		public float MrkSize => Native.ZkParticleEffectInstance_getMrkSize(Handle);

		public string FlockMode =>
			Native.ZkParticleEffectInstance_getFlockMode(Handle).MarshalAsString() ?? string.Empty;
		...
		public string TimeStartEndS =>
			Native.ZkParticleEffectInstance_getTimeStartEndS(Handle).MarshalAsString() ?? string.Empty;
