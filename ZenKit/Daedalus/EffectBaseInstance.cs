...
namespace ZenKit.Daedalus
{
	public class EffectBaseInstance : DaedalusInstance
	{
		...
		public string VisAlphaBlendFuncS =>
			Native.ZkEffectBaseInstance_getVisAlphaBlendFuncS(Handle).MarshalAsString() ?? string.Empty;
		...
		public string EmTrjOriginNode =>
			Native.ZkEffectBaseInstance_getEmTrjOriginNode(Handle).MarshalAsString() ?? string.Empty;

		public string EmTrjTargetNode =>
			Native.ZkEffectBaseInstance_getEmTrjTargetNode(Handle).MarshalAsString() ?? string.Empty;
		...
		public string EmTrjLoopModeS =>
			Native.ZkEffectBaseInstance_getEmTrjLoopModeS(Handle).MarshalAsString() ?? string.Empty;

		public string EmTrjEaseFuncS =>
			Native.ZkEffectBaseInstance_getEmTrjEaseFuncS(Handle).MarshalAsString() ?? string.Empty;
		...
		public string EmFxCreateS =>
			Native.ZkEffectBaseInstance_getEmFxCreateS(Handle).MarshalAsString() ?? string.Empty;

		public string EmFxInvestOriginS =>
			Native.ZkEffectBaseInstance_getEmFxInvestOriginS(Handle).MarshalAsString() ?? string.Empty;

		public string EmFxInvestTargetS =>
			Native.ZkEffectBaseInstance_getEmFxInvestTargetS(Handle).MarshalAsString() ?? string.Empty;
		...
		public string EmActionCollDynS =>
			Native.ZkEffectBaseInstance_getEmActionCollDynS(Handle).MarshalAsString() ?? string.Empty;

		public string EmActionCollStatS =>
			Native.ZkEffectBaseInstance_getEmActionCollStatS(Handle).MarshalAsString() ?? string.Empty;

		public string EmFxCollStatS =>
			Native.ZkEffectBaseInstance_getEmFxCollStatS(Handle).MarshalAsString() ?? string.Empty;

		public string EmFxCollDynS =>
			Native.ZkEffectBaseInstance_getEmFxCollDynS(Handle).MarshalAsString() ?? string.Empty;

		public string EmFxCollStatAlignS =>
			Native.ZkEffectBaseInstance_getEmFxCollStatAlignS(Handle).MarshalAsString() ?? string.Empty;

		public string EmFxCollDynAlignS =>
			Native.ZkEffectBaseInstance_getEmFxCollDynAlignS(Handle).MarshalAsString() ?? string.Empty;
		...
		public string EmSelfRotVelS =>
			Native.ZkEffectBaseInstance_getEmSelfRotVelS(Handle).MarshalAsString() ?? string.Empty;

		public string LightPresetName =>
			Native.ZkEffectBaseInstance_getLightPresetName(Handle).MarshalAsString() ?? string.Empty;
		...
		public string EmFxCollDynPercS =>
			Native.ZkEffectBaseInstance_getEmFxCollDynPercS(Handle).MarshalAsString() ?? string.Empty;

		public string UserString(ulong i)
		{
