...
namespace ZenKit
{
	...
	internal static class Native
	{
		...
		private const string DLLNAME = "runtimes/linux-x64/libczenkit.so";
		...
		[DllImport(DLLNAME)]
		public static extern void ZkDaedalusVm_registerExternal(UIntPtr slf, UIntPtr sym, ZkDaedalusVmExternalCallback cb,
			UIntPtr ctx);

		[DllImport(DLLNAME)]
		public static extern void ZkDaedalusVm_registerExternalDefault(UIntPtr slf, ZkDaedalusVmExternalDefaultCallback cb,
			UIntPtr ctx);
