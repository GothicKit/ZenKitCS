...
public class MultiResolutionSubMesh
{
	...
	public Material Material => new(Native.ZkSubMesh_getMaterial(_handle));
...
public class MultiResolutionMesh
{
	...
	public OrientedBoundingBox OrientedBoundingBox => new(Native.ZkMultiResolutionMesh_getOrientedBbox(_handle));
